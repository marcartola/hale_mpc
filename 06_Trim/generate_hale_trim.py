...
for case_uinf in [7, 8, 9, 10, 11, 12]:
    for case_lm in [25, 35, 45, 50]:

        case_name = 'simple_HALE_trim_uinf_' + str(case_uinf)  + '_lm_' + str(case_lm)
...
# trim sigma = 1.5
        alpha = 4.0591*np.pi/180
        beta = 0
        roll = 0
        gravity = 'on'
        cs_deflection = -1.2729*np.pi/180
